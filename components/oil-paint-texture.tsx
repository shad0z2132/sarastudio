...
/**
 * OilPaintTexture — organic brushstroke texture overlay.
 *
 * Multi-layered noise at different scales to simulate oil paint
 * canvas texture. More organic than simple grain.
 */

export function OilPaintTexture() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-[1]">
      ...
      <div
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.02' numOctaves='5' stitchTiles='stitch'/%3E%3CfeColorMatrix type='saturate' values='0'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)'/%3E%3C/svg%3E")`,
          backgroundRepeat: "repeat",
